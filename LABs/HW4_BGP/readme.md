...
Выбран iBGP. Учтены рекомендации уроков iBGP/eBGP (пароль DC_FABRIC для аутентификации на линках leaf-spine, multipath, RR на spines, route-map, подкручены таймеры 3/9, также включен BFD)
